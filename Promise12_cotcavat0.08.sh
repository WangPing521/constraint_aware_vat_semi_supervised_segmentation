...
#"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=prostate Trainer.name=cotconsVAT Constraints.Constraint=connectivity ConstraintWeightScheduler.max_value=0.0007  VATsettings.pertur_eps=0.00001 RegScheduler.max_value=0.0003 Trainer.checkpoint_path=runs/${save_dir}/cotCaVAT_303reg_401eps_307cons  Trainer.save_dir=${save_dir}/cotCaVAT_303reg_401eps_307cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=123456  Arch.num_classes=2 Dataset=prostate Trainer.name=cotconsVAT Constraints.Constraint=connectivity ConstraintWeightScheduler.max_value=0.0007  VATsettings.pertur_eps=0.00001 RegScheduler.max_value=0.0003  Trainer.save_dir=${save_dir}/cotCaVAT_303reg_401eps_307cons_run2 Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=12345   Arch.num_classes=2 Dataset=prostate Trainer.name=cotconsVAT Constraints.Constraint=connectivity ConstraintWeightScheduler.max_value=0.0007  VATsettings.pertur_eps=0.00001 RegScheduler.max_value=0.0003  Trainer.save_dir=${save_dir}/cotCaVAT_303reg_401eps_307cons_run3 Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

#"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=prostate Trainer.name=cotconsVAT Constraints.Constraint=connectivity ConstraintWeightScheduler.max_value=0.001   VATsettings.pertur_eps=0.00001 RegScheduler.max_value=0.0003 Trainer.checkpoint_path=runs/${save_dir}/cotCaVAT_303reg_401eps_201cons  Trainer.save_dir=${save_dir}/cotCaVAT_303reg_401eps_201cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=123456  Arch.num_classes=2 Dataset=prostate Trainer.name=cotconsVAT Constraints.Constraint=connectivity ConstraintWeightScheduler.max_value=0.001   VATsettings.pertur_eps=0.00001 RegScheduler.max_value=0.0003  Trainer.save_dir=${save_dir}/cotCaVAT_303reg_401eps_201cons_run2 Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=12345   Arch.num_classes=2 Dataset=prostate Trainer.name=cotconsVAT Constraints.Constraint=connectivity ConstraintWeightScheduler.max_value=0.001   VATsettings.pertur_eps=0.00001 RegScheduler.max_value=0.0003  Trainer.save_dir=${save_dir}/cotCaVAT_303reg_401eps_201cons_run3 Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

...
# psedo label
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity Constraints.cons_weight=0.05     Trainer.save_dir=${save_dir}/convex_LV_pseudo_105cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity Constraints.cons_weight=0.005    Trainer.save_dir=${save_dir}/convex_LV_pseudo_205cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity Constraints.cons_weight=0.0005   Trainer.save_dir=${save_dir}/convex_LV_pseudo_305cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity Constraints.cons_weight=0.00005  Trainer.save_dir=${save_dir}/convex_LV_pseudo_405cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity Constraints.cons_weight=0.000005 Trainer.save_dir=${save_dir}/convex_LV_pseudo_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

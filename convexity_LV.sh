...
time=6
account=def-chdesa
save_dir=cons_LV_schedulerweight
...
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=defects ConstraintWeightScheduler.max_value=0.000005 Trainer.save_dir=${save_dir}/convex_LV_defects_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=defects ConstraintWeightScheduler.max_value=0.00005  Trainer.save_dir=${save_dir}/convex_LV_defects_405cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=defects ConstraintWeightScheduler.max_value=0.0005   Trainer.save_dir=${save_dir}/convex_LV_defects_305cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=defects ConstraintWeightScheduler.max_value=0.005    Trainer.save_dir=${save_dir}/convex_LV_defects_205cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=defects ConstraintWeightScheduler.max_value=0.05     Trainer.save_dir=${save_dir}/convex_LV_defects_105cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=convex_hull ConstraintWeightScheduler.max_value=0.000005 Trainer.save_dir=${save_dir}/convex_LV_hull_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=convex_hull ConstraintWeightScheduler.max_value=0.00005  Trainer.save_dir=${save_dir}/convex_LV_hull_405cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=convex_hull ConstraintWeightScheduler.max_value=0.0005   Trainer.save_dir=${save_dir}/convex_LV_hull_305cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=convex_hull ConstraintWeightScheduler.max_value=0.005    Trainer.save_dir=${save_dir}/convex_LV_hull_205cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=convex_hull ConstraintWeightScheduler.max_value=0.05     Trainer.save_dir=${save_dir}/convex_LV_hull_105cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_FG ConstraintWeightScheduler.max_value=0.000005 Trainer.save_dir=${save_dir}/convex_LV_FG_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_FG ConstraintWeightScheduler.max_value=0.00005  Trainer.save_dir=${save_dir}/convex_LV_FG_405cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_FG ConstraintWeightScheduler.max_value=0.0005   Trainer.save_dir=${save_dir}/convex_LV_FG_305cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_FG ConstraintWeightScheduler.max_value=0.005    Trainer.save_dir=${save_dir}/convex_LV_FG_205cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_FG ConstraintWeightScheduler.max_value=0.05     Trainer.save_dir=${save_dir}/convex_LV_FG_105cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_BG ConstraintWeightScheduler.max_value=0.000005 Trainer.save_dir=${save_dir}/convex_LV_BG_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_BG ConstraintWeightScheduler.max_value=0.00005  Trainer.save_dir=${save_dir}/convex_LV_BG_405cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_BG ConstraintWeightScheduler.max_value=0.0005   Trainer.save_dir=${save_dir}/convex_LV_BG_305cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_BG ConstraintWeightScheduler.max_value=0.005    Trainer.save_dir=${save_dir}/convex_LV_BG_205cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=pseudo_like_BG ConstraintWeightScheduler.max_value=0.05     Trainer.save_dir=${save_dir}/convex_LV_BG_105cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=constraintReg Constraints.Constraint=convexity Constraints.Convexity.credit_types=reverse_FGBG ConstraintWeightScheduler.max_value=0.000005 Trainer.save_dir=${save_dir}/convex_LV_FGBG_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
...
# psedo label
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity ConstraintWeightScheduler.max_value=0.05     Trainer.save_dir=${save_dir}/convex_LV_pseudo_105cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity ConstraintWeightScheduler.max_value=0.005    Trainer.save_dir=${save_dir}/convex_LV_pseudo_205cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity ConstraintWeightScheduler.max_value=0.0005   Trainer.save_dir=${save_dir}/convex_LV_pseudo_305cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity ConstraintWeightScheduler.max_value=0.00005  Trainer.save_dir=${save_dir}/convex_LV_pseudo_405cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"
"python -O main.py seed=1234567 Arch.num_classes=2 Dataset=acdc Foreground=LV Optim.lr=0.00001 Trainer.name=Pseudolike Constraints.Constraint=convexity ConstraintWeightScheduler.max_value=0.000005 Trainer.save_dir=${save_dir}/convex_LV_pseudo_505cons Data.unlabeled_data_ratio=${unlab_ratio2} Data.labeled_data_ratio=${ratio2}"

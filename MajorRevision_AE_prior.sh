...
"python -O main.py pyseed=123456  Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.01 ConstraintWeightScheduler.max_value=0.0000001 RegScheduler.max_value=0.000001 Trainer.save_dir=${save_dir}/AE_501reg_101_601prior_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=12345   Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.01 ConstraintWeightScheduler.max_value=0.0000001 RegScheduler.max_value=0.000001 Trainer.save_dir=${save_dir}/AE_501reg_101_601prior_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"

#"python -O main.py pyseed=1234567 Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.01 ConstraintWeightScheduler.max_value=0.000001  RegScheduler.max_value=0.00000001 Trainer.save_dir=${save_dir}/AE_701reg_101_501prior_run1 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=123456  Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.01 ConstraintWeightScheduler.max_value=0.000001  RegScheduler.max_value=0.00000001 Trainer.save_dir=${save_dir}/AE_701reg_101_501prior_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=12345   Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.01 ConstraintWeightScheduler.max_value=0.000001  RegScheduler.max_value=0.00000001 Trainer.save_dir=${save_dir}/AE_701reg_101_501prior_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
...
"python -O main.py pyseed=123456  Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.05 ConstraintWeightScheduler.max_value=0.0001    RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_105_301prior_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=12345   Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.05 ConstraintWeightScheduler.max_value=0.0001    RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_105_301prior_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"

"python -O main.py pyseed=1234567 Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.05 ConstraintWeightScheduler.max_value=0.000001  RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_105_501prior_run1 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=123456  Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.05 ConstraintWeightScheduler.max_value=0.000001  RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_105_501prior_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=12345   Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.05 ConstraintWeightScheduler.max_value=0.000001  RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_105_501prior_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
...
"python -O main.py pyseed=123456  Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.1 ConstraintWeightScheduler.max_value=0.0000001 RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_01_601prior_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py pyseed=12345   Arch.num_classes=4 Dataset=acdc Foreground=all Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.1 ConstraintWeightScheduler.max_value=0.0000001 RegScheduler.max_value=0.0000001 Trainer.save_dir=${save_dir}/AE_601reg_01_601prior_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"

...
"python -O main.py seed=123456  Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=Baselines MinEntropy=False Reg_cons=False Temperature=1 Trainer.checkpoint_path=runs/20230102_hippocampus_005L/baselineF_run2 Trainer.save_dir=${save_dir}/baselineF_run2 Data.unlabeled_data_ratio=0.01 Data.labeled_data_ratio=0.99"
"python -O main.py seed=12345   Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=Baselines MinEntropy=False Reg_cons=False Temperature=1 Trainer.checkpoint_path=runs/20230102_hippocampus_005L/baselineF_run3 Trainer.save_dir=${save_dir}/baselineF_run3 Data.unlabeled_data_ratio=0.01 Data.labeled_data_ratio=0.99"
#
## baseline_p
...
"python -O main.py seed=123456  Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=Baselines MinEntropy=False Reg_cons=False Temperature=1 Trainer.checkpoint_path=runs/20230102_hippocampus_005L/baselineP_run2 Trainer.save_dir=${save_dir}/baselineP_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py seed=12345   Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=Baselines MinEntropy=False Reg_cons=False Temperature=1 Trainer.checkpoint_path=runs/20230102_hippocampus_005L/baselineP_run3 Trainer.save_dir=${save_dir}/baselineP_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
...
"python -O main.py seed=123456  Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=Baselines MinEntropy=True Reg_cons=False Temperature=1 RegScheduler.max_value=0.0001 Trainer.checkpoint_path=runs/20230103_hippocampus_005L/EntMin_301reg_run2 Trainer.save_dir=${save_dir}/EntMin_301reg_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py seed=12345   Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=Baselines MinEntropy=True Reg_cons=False Temperature=1 RegScheduler.max_value=0.0001 Trainer.checkpoint_path=runs/20230103_hippocampus_005L/EntMin_301reg_run3 Trainer.save_dir=${save_dir}/EntMin_301reg_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
...
"python -O main.py seed=123456  Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=NaiveVat VATsettings.pertur_eps=0.5 RegScheduler.max_value=0.005 Trainer.checkpoint_path=runs/20230103_hippocampus_005L/vat_205reg_run2 Trainer.save_dir=${save_dir}/vat_205reg_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py seed=12345   Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=NaiveVat VATsettings.pertur_eps=0.5 RegScheduler.max_value=0.005 Trainer.checkpoint_path=runs/20230103_hippocampus_005L/vat_205reg_run3 Trainer.save_dir=${save_dir}/vat_205reg_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
...
"python -O main.py seed=123456 Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=MTconsvat VATeps=0 Reg_cons=False Plugin.mode=vat Temperature=0.5 RegScheduler.max_value=2  Trainer.checkpoint_path=runs/20230103_hippocampus_005L/MT_2reg_run2 Trainer.save_dir=${save_dir}/MT_2reg_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py seed=12345  Arch.num_classes=3 Dataset=hippocampus Optim.lr=0.00001 Trainer.name=MTconsvat VATeps=0 Reg_cons=False Plugin.mode=vat Temperature=0.5 RegScheduler.max_value=2  Trainer.checkpoint_path=runs/20230103_hippocampus_005L/MT_2reg_run3 Trainer.save_dir=${save_dir}/MT_2reg_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
...
"python -O main.py seed=123456 Arch.num_classes=3 Dataset=hippocampus Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.1 ConstraintWeightScheduler.max_value=0.0005  RegScheduler.max_value=0.000001  Trainer.checkpoint_path=runs/20230103_hippocampus_005L/AE_501reg_01_305prior_run2 Trainer.save_dir=${save_dir}/AE_501reg_01_305prior_run2 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"
"python -O main.py seed=12345  Arch.num_classes=3 Dataset=hippocampus Trainer.name=AE_prior ae_lr=0.000001 Constraints.Constraint=convexity adv_reg=0.1 ConstraintWeightScheduler.max_value=0.0005  RegScheduler.max_value=0.000001  Trainer.checkpoint_path=runs/20230103_hippocampus_005L/AE_501reg_01_305prior_run3 Trainer.save_dir=${save_dir}/AE_501reg_01_305prior_run3 Data.unlabeled_data_ratio=${unlab_ratio1} Data.labeled_data_ratio=${ratio1}"

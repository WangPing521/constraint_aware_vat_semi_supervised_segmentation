...
class ProstateDKDataset(MedicalImageSegmentationDataset):
    download_link = "https://drive.google.com/file/d/1EdQSuZ_YoooSd31MkJp3dBV_vf71DA2r/view?usp=sharing"
    zip_name = "Decathlon_Prostate.zip"
    folder_name = "Decathlon_Prostate"
...
class ProstateDKSemiInterface(MedicalDatasetSemiInterface):
    def __init__(
        self,
        root_dir=DATA_PATH,
